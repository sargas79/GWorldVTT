        ...
        parts: [
          {
            content: {
              ...
              items: [
                ...
                m("MoveAndAttack", {
                  value: signed(MOVE_AND_ATTACK_PENALTY),
                  cap: WILD_SWING_SKILL_CAP,
                }),
                m("Deceptive", {
                  attack: signed(deceptiveAttack(20, 1).attackPenalty),
                  defense: signed(deceptiveAttack(20, 1).defensePenalty),
                  floor: DECEPTIVE_SKILL_FLOOR,
                }),
                m("RapidStrike", { value: signed(RAPID_STRIKE_PENALTY) }),
                m("DualWeapon", { value: signed(dual.primary), offHand: signed(dual.offHand) }),
                m("Posture", {
                  low: signed(POSTURE_EFFECTS.kneeling.attack),
                  lying: signed(POSTURE_EFFECTS.lying.attack),
                }),
                ...
                m("CannotSee", {
                  ...
                  accustomed: signed(
                    attackWithoutSight({ sight: "blind", accustomedToBlindness: true }).modifier,
                  ),
                ...
                m("Chinks", {
                  torso: signed(chinkPenalty("torso")),
                  other: signed(chinkPenalty("skull")),
                }),
        ...
        parts: [
          {
            content: {
              ...
              items: [
                m("AllOutDefense", {
                  value: gain(parry(14, { allOutDefenseIncreased: true }).total, parry(14).total),
                }),
                m("Retreat", {
                ...
                m("Acrobatic", {
                  success: signed(acrobaticDefenseModifier(true)),
                  failure: signed(acrobaticDefenseModifier(false)),
                }),
                m("Feverish", { value: signed(FEVERISH_DEFENSE_BONUS) }),
                m("Shield"),
                m("CombatReflexes", {
                  value: gain(dodge(7, { combatReflexes: true }).total, dodge(7).total),
                }),
                m("Posture", {
                  low: signed(POSTURE_EFFECTS.kneeling.defense),
                  lying: signed(POSTURE_EFFECTS.lying.defense),
                }),
                m("Side", { value: signed(side.modifier) }),
                m("Behind", {
                  value: signed(behind.modifier),
                  parry: signed(behind.parryModifier),
                }),
                ...
                m("Unarmed", {
                  value: signed(
                    bareHandedParryModifier({
                      ...
                      bareHanded: true,
                      attackIsWeapon: true,
                      attackIsThrust: false,
                    }),
                  ),
                }),
                m("Thrown", {
                  value: signed(thrownParryModifier(5)),
                  small: signed(thrownParryModifier(1)),
                }),
                m("Flail", {
                  parry: signed(flailDefenseModifier("flail", "parry")),
                  block: signed(flailDefenseModifier("flail", "block")),
                }),
                m("DualTarget", {
                  value: signed(dualWeaponAttack({ sameTarget: true }).defensePenalty),
                }),
                m("Encumbrance", {
                  value: gain(dodge(7, { encumbrance: 1 }).total, dodge(7).total),
                }),
              ],
            },
          },
    ...
    build: ({ t }) => {
      ...
      const rows: GmRow[] = [
        { key: at(3), cells: [t(`${K}.Hp.BelowThird`), t(`${K}.Hp.Reeling`)] },
        {
          ...
          cells: [
            t(`${K}.Hp.Zero`),
            t(`${K}.Hp.ZeroText`, { value: signed(consciousnessRollPenalty(-10, 10)) }),
          ],
        },
        ...
        parts: [
          {
            content: {
              kind: "table",
              columns: [t(`${K}.Column.HpLeft`), t(`${K}.Column.Effect`)],
              rows,
            },
          },
        ],
        ...
        parts: [
          {
            content: {
              kind: "table",
              columns: [t(`${K}.Column.FpLeft`), t(`${K}.Column.Effect`)],
              rows,
            },
          },
        ],
      ...
      parts: [
        {
          content: {
            kind: "table",
            columns: [
              t(`${K}.Column.EffectiveSkill`),
              t(`${K}.Column.CriticalSuccess`),
              t(`${K}.Column.CriticalFailure`),
            ],
            rows: criticalRows(),
          },
        },
  ...
  section({
    ...
    build: ({ t }) => ({
      parts: [
        {
          id: "ruleOf14",
          heading: t(partKey("rulesOf", "Fourteen")),
          cite: "p. B360",
          content: {
            kind: "rules",
            items: [
              {
                term: t(partKey("rulesOf", "FourteenTerm")),
                text: t(partKey("rulesOf", "FourteenText"), {
                  cap: FRIGHT_CHECK_CEILING,
                  fail: FRIGHT_CHECK_CEILING + 1,
                }),
              },
            ],
          },
        ...
        {
          id: "ruleOf16",
          heading: t(partKey("rulesOf", "Sixteen")),
          cite: "p. B349",
          content: {
            kind: "rules",
            items: [
              {
                term: t(partKey("rulesOf", "SixteenTerm")),
                text: t(partKey("rulesOf", "SixteenText"), { cap: ruleOf16(99, 0) }),
              },
            ],
          },
        },
        {
          id: "ruleOf20",
          heading: t(partKey("rulesOf", "Twenty")),
          cite: "p. B173",
          content: {
            kind: "rules",
            items: [
              {
                term: t(partKey("rulesOf", "TwentyTerm")),
                text: t(partKey("rulesOf", "TwentyText"), { cap: RULE_OF_20_CAP }),
              },
            ],
          },
        },
