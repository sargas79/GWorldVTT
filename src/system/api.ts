 ...
 */
export const API_VERSION = "1.97.0";
 ...
 * `darknessAt`, the darkness at a token or a point, since 1.96.0.
 */
const areasApi = Object.freeze({ add: addArea, remove: removeArea, list: listAreas, standsIn: tokensInArea, darknessAt });
